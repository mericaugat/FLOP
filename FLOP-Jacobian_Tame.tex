...
This is a crucial aspect of Umirbaev's (\cite{JacTame-U07}) proof that the Anick automorphism is wild.
However, Park and Woodburn \cite{JacTame-PW95} give a decomposition of $(\begin{smallmatrix} \mathfrak{C} & 0 \\ 0 & 1 \end{smallmatrix})$ 
