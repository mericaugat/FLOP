...
This is a crucial aspect of Umirbaev's (\cite{JacTameU07}) proof that the Anick automorphism is wild.
However, Park and Woodburn \cite{JacTamePW95} give a decomposition of $(\begin{smallmatrix} \mathfrak{C} & 0 \\ 0 & 1 \end{smallmatrix})$ 
...
I am not yet sure where to go with {\bf Jacobian Tame} since I cannot think of any nice properties that such automorphisms would satisfy.
